import * as bingo_stratum7 from "bingo-stratum";

//#region src/blocks/blockRepositorySecrets.d.ts
declare const blockRepositorySecrets: bingo_stratum7.BlockWithAddons<{
  secrets: {
    name: string;
    description: string;
  }[];
...
//# sourceMappingURL=blockRepositorySecrets.d.ts.map