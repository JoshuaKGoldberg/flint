import * as bingo_stratum21 from "bingo-stratum";

//#region src/blocks/blockExampleFiles.d.ts
declare const blockExampleFiles: bingo_stratum21.BlockWithAddons<{
  usage: string[];
...
//# sourceMappingURL=blockExampleFiles.d.ts.map