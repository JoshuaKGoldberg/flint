import * as bingo_stratum95 from "bingo-stratum";

//#region src/blocks/blockGitHubActionsCI.d.ts
declare const blockGitHubActionsCI: bingo_stratum95.BlockWithAddons<{
  jobs?: {
    name: string;
    steps: ({
...
//# sourceMappingURL=blockGitHubActionsCI.d.ts.map