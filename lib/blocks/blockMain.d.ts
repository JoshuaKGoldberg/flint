import * as bingo_stratum1 from "bingo-stratum";

//#region src/blocks/blockMain.d.ts
declare const blockMain: bingo_stratum1.BlockWithAddons<{
  runArgs: string[];
...
//#endregion
export { blockMain };
//# sourceMappingURL=blockMain.d.ts.map