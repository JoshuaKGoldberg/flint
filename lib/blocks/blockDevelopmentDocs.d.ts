import * as bingo_stratum77 from "bingo-stratum";

//#region src/blocks/blockDevelopmentDocs.d.ts
declare const blockDevelopmentDocs: bingo_stratum77.BlockWithAddons<{
  hints: string[];
...
//# sourceMappingURL=blockDevelopmentDocs.d.ts.map