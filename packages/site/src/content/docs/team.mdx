	...
	bios={[
		{
			description: "...",
			extras: [
				"auvred is a team member of [typescript-eslint](https://typescript-eslint.io) and the original creator of [tsgolint](https://github.com/typescript-eslint/tsgolint). auvred brings deep expertise in typed linting as well as integrating with the Vite and Vue ecosystems.",
			],
			username: "auvred",
		},
		{
