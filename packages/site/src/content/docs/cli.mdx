...
<PackageManagers arg="--presenter detailed" pkg="flint" type="dlx" />
...
Language plugins such as are able to report additional checks from the languages after linting.
