...
If your codebase uses `.some()` for consistency even with simple equality checks, or if you have a large number of existing uses that would be difficult to refactor, you may disable this rule.
