...
If you're working in a codebase where symbol descriptions aren't important for debugging purposes, or if you have a specific reason to create symbols without descriptions, you might choose to disable this rule.
