...
const result = object.property === object.property; // Always true (except for NaN)
...
This rule should generally always be enabled as self-comparisons are almost certainly mistakes.
