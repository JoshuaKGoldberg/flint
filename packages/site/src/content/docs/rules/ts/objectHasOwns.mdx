...
For projects with a large existing codebase using the older patterns, the refactoring effort might be significant.
In such cases, you can disable this rule and migrate gradually.
