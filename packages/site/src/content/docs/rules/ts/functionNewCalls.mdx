---
description: "Prefer function declarations or arrow functions over the Function constructor."
...
- [MDN documentation on the Function constructor](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function/Function)
- [MDN documentation on eval and security](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/eval#never_use_direct_eval!)
