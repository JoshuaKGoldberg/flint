---
description: "The update moves the counter in the wrong direction for this loop condition."
title: "forDirections"
topic: "rules"
---
...
A for loop counter moving in the wrong direction indicates a logic error that will cause infinite loops or loops that never execute.
