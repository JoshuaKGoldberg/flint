...
If your project uses control flow structures that create confusing side effects, such as an environment where GitHub Flavored Markdown autolink literals are fully supported and you prefer their simplicity, you might not be able to enable this rule.
Consider standardizing on proper Markdown formatting for better compatibility across different parsers and renderers.
