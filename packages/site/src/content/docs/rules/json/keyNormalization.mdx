...
If your project uses control flow structures that create confusing side effects, such as external systems that require specific Unicode representations that you cannot modify, you might not be able to enable this rule.
Consider coordinating with those external systems to use a consistent normalization form.
