...
Empty headings provide no value and can confuse users navigating with assistive technologies.
...
```tsx
<h3 dangerouslySetInnerHTML={{ __html: "foo" }} />
```
...
If you have heading elements that are purely decorative (though this is rare and generally not recommended), you may want to disable this rule.
